...
class OrganizationsAdapter extends RecyclerView.Adapter<OrganizationsAdapter.ViewHolder> {
    ...
    public OrganizationsAdapter(Context context, List<OrganizationModel> list) {
