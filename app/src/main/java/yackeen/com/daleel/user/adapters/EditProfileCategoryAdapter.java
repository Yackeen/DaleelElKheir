...
/**
 * Created by Ibrahim on 18/02/2018.
 */

public class EditProfileCategoryAdapter extends RecyclerView.Adapter<EditProfileCategoryAdapter.ViewHolder> {

    private static final String TAG = "EditProfileCategoryAdap";
    private Context context;
    private List<FavouriteCategoriesModel> list = new ArrayList<>();
    private PrefManager manager;
    private User user;

    public EditProfileCategoryAdapter(Context context, List<FavouriteCategoriesModel> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.edit_category_list, parent, false));
    }
